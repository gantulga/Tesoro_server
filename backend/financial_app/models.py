...
class Wallet(Createdinfo):
    ...
    balance = models.DecimalField(max_digits=14, decimal_places=2, null=False, blank=False, default=0)
    owner = models.ForeignKey(User, related_name='wallets', null=True, blank=True, on_delete=models.DO_NOTHING)
...
class Money_transfer(Modifiedinfo):
    fr_wallet = models.ForeignKey(
        'Wallet', related_name='moneytransfers_fr_wallet', null=True, blank=True, on_delete=models.DO_NOTHING)
    to_wallet = models.ForeignKey(
        'Wallet', related_name='moneytransfers_to_wallet', null=True, blank=True, on_delete=models.DO_NOTHING)
    msg_info_fee = models.DecimalField(
        max_digits=14, decimal_places=2, null=True, blank=True, default=0)
    transfer_fee = models.DecimalField(
        max_digits=14, decimal_places=2, null=True, blank=True, default=0)
    ...
    fr_user = models.ForeignKey(User, related_name='moneytransfers_fr_user',
                                null=True, blank=True, on_delete=models.DO_NOTHING)
    to_user = models.ForeignKey(User, related_name='moneytransfers_to_user',
                                null=True, blank=True, on_delete=models.DO_NOTHING)
    fr_budget = models.ForeignKey(
        'Budget', related_name='moneytransfers_fr_budget', null=True, blank=True, on_delete=models.DO_NOTHING)
    to_budget = models.ForeignKey(
        'Budget', related_name='moneytransfers_to_budget', null=True, blank=True, on_delete=models.DO_NOTHING)
    ...
    fr_investment = models.ForeignKey(
        'Investment', related_name='moneytransfers_fr_investment', null=True, blank=True, on_delete=models.DO_NOTHING)
    to_investment = models.ForeignKey(
        'Investment', related_name='moneytransfers_to_investment', null=True, blank=True, on_delete=models.DO_NOTHING)
    fr_loan = models.ForeignKey(
        'Loan', related_name='moneytransfers_fr_loan', null=True, blank=True, on_delete=models.DO_NOTHING)
    to_loan = models.ForeignKey(
        'Loan', related_name='moneytransfers_to_loan', null=True, blank=True, on_delete=models.DO_NOTHING)
    amount = models.DecimalField(
        max_digits=14, decimal_places=2, null=True, blank=True, default=0)
    shift_work = models.ForeignKey(
        'structure_app.Shift_work', related_name='moneytransfers', null=True, blank=True, on_delete=models.DO_NOTHING)
