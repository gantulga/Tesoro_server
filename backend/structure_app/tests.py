...
# from financial_app.models import Currency, Money_transfer_type
...
#         },
#         {
#             "model": "financial_app.Money_transfer_type",
#             "pk": 1,
#             "fields": {
#                 "created_at": "2020-01-05T07:34:51.148Z",
#                 "name": "Орлогын гүйлгээ",
#                 "description": "Үйлчилгээ үзүүлээд олсон мөнгөний гүйлгээ.",
#                 "created_by": 1,
#             }
#         },
#         {
...
#                 "created_by": 1,
#                 "number": 5001,
#                 "description": "Лоунж бармен хэсэг",
#                 "division": 5,
#             }
#         },
#         {
...
#                 "created_by": 1,
#                 "parent": 0,
#                 "name": "Зочид буудлын MiniBar",
#                 "description": "Зочид буудлын өрөөний хөргөгч болон худалдан авч болох бэлэн бүтээгдэхүүнүүд.",
#             }
#         },
#         {
...
#     'mysql+mysqldb://root:@localhost:3306/tesoro_mn?charset=utf8&use_unicode=0')
...
#         modelName = "Currency"
#     elif str(python_obj['model']) == "financial_app.Money_transfer_type":
#         tableName = "financial_app_money_transfer_type"
#         modelName = "Money_transfer_type"
...
#         elif modelName == "Money_transfer_type":
#             dbitem = Money_transfer_type()
#             for k, v in python_obj['fields'].items():
#                 if str(k) == "created_by":
#                     getObject = User.objects.get(pk=int(v))
#                     setattr(dbitem, k, getObject)
...
#             dbitem.id = python_obj['pk']
#             dbitem.save()
#             print("Saved Money_transfer_type")
